...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  var nuevo_amigo = usuario["amigos"];
  nuevo_amigo.push(nuevoAmigo);
  usuario["amigos"] = nuevo_amigo;
  return usuario;
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  calcularPrecioDescuentof = function(){
    var descuento = 0;
    var precio_final = 0;
  ...
  producto.calcularPrecioDescuento = calcularPrecioDescuentof;
  return producto;
}
